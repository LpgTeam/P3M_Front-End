            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <h2>Bagus Setiawan S.S.T., M.T.</h2>
                        <h3>Lektor</h3>
                        <div class="social-links mt-2">
                            <p>
                                <i class="bi bi-envelope-fill">&nbsp bagsetya@stis.ac.id</i>
                            </p>
                            <p class="twitter">
                        ...
                        <div class="tab-content pt-2">
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">bagsetya@stis.ac.id</div>
                                </div>
